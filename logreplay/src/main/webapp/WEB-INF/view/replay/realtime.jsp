			     	...
			     	<div id="J_queryArea" class="row" style="text-align: center;">
			     		...
			     		<form class="form-horizontal col-md-offset-2 col-md-8" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" id="J_pageNo" name="deviceId" placeholder="请输入页面编号" />
								</div>
								<label for="J_uvid" class="col-sm-2 control-label">操作编号：</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="J_tagNo" name="uvid" placeholder="请输入操作编号" />
								</div>
							</div>
							<div class="form-group">
