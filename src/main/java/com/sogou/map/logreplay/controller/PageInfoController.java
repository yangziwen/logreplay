...
public class PageInfoController extends BaseController {
	...
	public void export(
		...
		String filename = ProductUtil.getCurrentProduct().getName() + "_Ò³ÃæÏêÇé.xls";
	...
	private static List<Column> buildPageInfoColumnList() {
		List<ExcelUtil.Column> columnList = Lists.newArrayList(
				ExcelUtil.column("Ò³Ãæ±àºÅ", "pageNo", 3000, ExcelUtil.CellType.number),
				ExcelUtil.column("Ò³ÃæÃû³Æ", "name", 8000, ExcelUtil.CellType.text)
		);
		return columnList;
	}
